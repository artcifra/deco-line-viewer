...
- если подключён второй монитор, Windows-версия по умолчанию открывается на нём
- сочетание `Ctrl+Shift+D` переносит kiosk-окно на следующий подключённый экран
